...
def XGB(X,Y,
    ...
    # summary = cross_validate(X=X,Y=Y,estimator=xgboost,c_grid=c_grid,seed=seed)
    return summary
...
def RF(X, Y,
    ...
    # summary = cross_validate(X=X,Y=Y,estimator=rf,c_grid=c_grid,seed=seed)
    return summary
...
def LinearSVM(X, Y, C, class_weight=None, seed=None):
    ...
    # summary = cross_validate(X=X,Y=Y,estimator=svm,c_grid=c_grid,seed=seed)
    return summary
...
def Lasso(X, Y, C, class_weight=None, seed=None):
    ...
    # summary = cross_validate(X=X,Y=Y,estimator=lasso,c_grid=c_grid,seed=seed)
    return summary
...
def Logistic(X, Y, C, class_weight=None, seed=None):
    ...
    # summary = cross_validate(X=X,Y=Y,estimator=lr,c_grid=c_grid,seed=seed)
    return summary
...
def DecisionTree(X, Y,
    ...
    # summary = cross_validate(X=X,Y=Y,estimator=dt,c_grid=c_grid,seed=seed)
    return summary

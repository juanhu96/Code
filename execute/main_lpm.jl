...
function main_lpm(dataset, N, feature_case, C0, max_point, max_runtime, num_threads, tol_gap, expdirpath, filename)

    z, feature_list, num_feature, num_obs, num_attr, x_order, num_order, v_order = initial(dataset, N, feature_case)

    intercept, theta, summary = estimate_MICP_lpm(z, C0, max_point, num_feature, num_obs, 

...
def compute_patient(FULL, setting_tag, exportdir='/export/storage_cures/CURES/Results/'):
    ...
    PATIENT_TP['first_pred_date'] = pd.to_datetime(PATIENT_TP['first_pred_date'], errors='coerce')
    PATIENT_TP['first_presc_date'] = pd.to_datetime(PATIENT_TP['first_presc_date'], errors='coerce')
    PATIENT_TP['firstpred_from_firstpresc'] = (PATIENT_TP['first_pred_date'] - PATIENT_TP['first_presc_date']).dt.days    

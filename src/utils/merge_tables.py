...
# table_names = ['Kern', 'Los Angeles', 'Riverside', 'San Bernardino', 'San Francisco', 'San Mateo'] # counties
...
# with open(f"{resultdir}summary_stats_merged.tex", "w") as f:
#     f.write(header + "\n".join(rows) + "\n" + footer)
# print("Merged LaTeX summary saved to summary_stats_merged.tex")
